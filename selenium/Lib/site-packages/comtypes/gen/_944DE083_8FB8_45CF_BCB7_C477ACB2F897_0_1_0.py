...
__all__ = [
    'SupportedTextSelection', 'UIA_VisualEffectsPropertyId',
    'UIA_SelectionPatternId', 'UIA_IsControlElementPropertyId',
    'UIA_StatusBarControlTypeId', 'UIA_MarginBottomAttributeId',
    'IUIAutomationElement2', 'NotificationKind_ItemAdded',
    'NotificationProcessing', 'UIA_UnderlineColorAttributeId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'IUIAutomationVirtualizedItemPattern', 'StyleId_Heading6',
    'UIA_LegacyIAccessibleNamePropertyId', 'UIA_DragPatternId',
    'TextUnit_Paragraph', 'AnnotationType_MoveChange',
    'UIA_WindowCanMinimizePropertyId', 'IUIAutomationElement3',
    'UIA_BeforeParagraphSpacingAttributeId', 'StyleId_Emphasis',
    'ToggleState_On', 'UIA_IsContentElementPropertyId',
    'UIA_FlowsFromPropertyId', 'TextPatternRangeEndpoint',
    'SynchronizedInputType_LeftMouseUp',
    'UIA_BoundingRectanglePropertyId',
    'WindowInteractionState_Closing', 'UIA_FontWeightAttributeId',
    'IUIAutomationCacheRequest', 'ProviderOptions_ClientSideProvider',
    'AnnotationType_GrammarError', 'ToggleState_Indeterminate',
    'IUIAutomationTextPattern', 'SynchronizedInputType_KeyUp',
    'UIA_WindowIsModalPropertyId', 'AutomationElementMode_Full',
    'UIA_IsSubscriptAttributeId', 'IUIAutomationElement8',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_CheckBoxControlTypeId', 'AnnotationType_ConflictingChange',
    'AnnotationType_DeletionChange', 'UIA_LevelPropertyId',
    'UIA_DragDropEffectPropertyId', 'OrientationType',
    'UIA_SelectionPattern2Id', 'UIA_HelpTextPropertyId',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'IUIAutomationSynchronizedInputPattern', 'ScrollAmount_NoAmount',
    'UIA_WindowPatternId', 'TreeScope', 'UIA_InputDiscardedEventId',
    'UIA_IsInvokePatternAvailablePropertyId',
    'AnnotationType_TrackChanges', 'UIA_ScrollPatternId',
    'IUIAutomationElementArray',
    'TextEditChangeType_CompositionFinalized', 'ProviderOptions',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_HyperlinkControlTypeId', 'UIA_LegacyIAccessiblePatternId',
    'IUIAutomationProxyFactoryEntry', 'IUIAutomationAndCondition',
    'AnnotationType_ExternalChange',
    'UIA_Selection2ItemCountPropertyId',
    'IUIAutomationPropertyCondition',
    'TextEditChangeType_AutoCorrect', 'UIA_InputReachedTargetEventId',
    'UIA_HeadingLevelPropertyId', 'UIA_SemanticZoomControlTypeId',
    'UIA_ActiveTextPositionChangedEventId',
    'UIA_TableColumnHeadersPropertyId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'UIA_HeaderItemControlTypeId', 'AnnotationType_Header',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_CustomNavigationPatternId', 'ZoomUnit_LargeIncrement',
    'IUIAutomationBoolCondition', 'UIA_StrikethroughColorAttributeId',
    'UIA_StylesFillColorPropertyId', 'UIA_FontNameAttributeId',
    'IUIAutomationTextRange2', 'IUIAutomationStylesPattern',
    'UIA_TabsAttributeId', 'UIA_ToolTipOpenedEventId',
    'HeadingLevel_None', 'Polite', 'DockPosition',
    'UIA_CustomControlTypeId', 'UIA_StylesPatternId',
    'UIA_MarginTopAttributeId',
    'UIA_WindowWindowVisualStatePropertyId',
    'AnnotationType_SpellingError', 'UIA_IsActiveAttributeId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'RowOrColumnMajor', 'UIA_MenuModeStartEventId',
    'AnnotationType_Endnote', 'UIA_StylesShapePropertyId',
    'AnnotationType_CircularReferenceError',
    'UIA_BulletStyleAttributeId', 'UIA_SayAsInterpretAsAttributeId',
    'IUIAutomationTextEditPattern', 'UIA_GridColumnCountPropertyId',
    'WindowVisualState_Minimized', 'UIA_TransformCanMovePropertyId',
    'UIA_TransformCanRotatePropertyId',
    'NotificationKind_ActionAborted',
    'UIA_ScrollVerticalViewSizePropertyId', 'ZoomUnit_SmallIncrement',
    'HeadingLevel9', 'ProviderOptions_ProviderOwnsSetFocus',
    'ProviderOptions_OverrideProvider', 'UIA_OrientationPropertyId',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'UIA_LabeledByPropertyId', 'ExpandCollapseState_Expanded',
    'UIA_RuntimeIdPropertyId', 'SynchronizedInputType_RightMouseDown',
    'UIA_IsValuePatternAvailablePropertyId',
    'UIA_SplitButtonControlTypeId', 'UIA_ScrollBarControlTypeId',
    'WindowVisualState', 'UIA_SelectionItem_ElementSelectedEventId',
    'AutomationElementMode_None', 'UIA_DragGrabbedItemsPropertyId',
    'UIA_MenuControlTypeId', 'IUIAutomationDragPattern',
    'UIA_OverlineColorAttributeId', 'ScrollAmount_SmallDecrement',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'RowOrColumnMajor_Indeterminate',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_RangeValueMaximumPropertyId', 'IUIAutomationNotCondition',
    'IUIAutomationGridPattern', 'UIA_TableControlTypeId',
    'UIA_SeparatorControlTypeId',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'UIA_MultipleViewPatternId', 'IUIAutomationTogglePattern',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'TextEditChangeType_Composition',
    'StructureChangeType_ChildrenReordered',
    'UIA_StylesExtendedPropertiesPropertyId',
    'UIA_DataItemControlTypeId', 'IUIAutomationSelectionPattern2',
    'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_Text_TextSelectionChangedEventId', 'ExpandCollapseState',
    'UIA_AfterParagraphSpacingAttributeId',
    'UIA_DragDropEffectsPropertyId',
    'UIA_AutomationFocusChangedEventId',
    'UIA_AnnotationObjectsAttributeId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'ExpandCollapseState_LeafNode', 'UIA_Drag_DragCancelEventId',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_GridItemContainingGridPropertyId',
    'ProviderOptions_UseClientCoordinates',
    'IUIAutomationInvokePattern', 'TextUnit_Line',
    'UIA_OutlineStylesAttributeId', 'CoalesceEventsOptions_Disabled',
    'AnnotationType_Comment', 'UIA_ListControlTypeId',
    'UIA_TextEdit_TextChangedEventId',
    'UIA_SelectionActiveEndAttributeId', 'IUIAutomationValuePattern',
    'UIA_IsRequiredForFormPropertyId', 'AnnotationType_Highlighted',
    'UIA_IsTableItemPatternAvailablePropertyId', 'HeadingLevel1',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'NotificationKind_ItemRemoved', 'StyleId_Heading2',
    'OrientationType_None', 'UIA_ObjectModelPatternId',
    'UIA_TransformPattern2Id', 'TreeScope_None',
    'UIA_TableRowHeadersPropertyId',
    'UIA_SelectionItemSelectionContainerPropertyId', 'StyleId_Title',
    'HeadingLevel3', 'IUIAutomationProxyFactory',
    'ProviderOptions_UseComThreading',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'PropertyConditionFlags_None', 'UIA_AnnotationTypesAttributeId',
    ...
    'UIA_PositionInSetPropertyId', 'UIA_FillColorPropertyId',
    'ZoomUnit_NoAmount', 'AnnotationType_Footnote',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'NavigateDirection_Parent', 'NavigateDirection',
    'UIA_MenuBarControlTypeId', 'IUIAutomationWindowPattern',
    'RowOrColumnMajor_RowMajor', 'WindowVisualState_Maximized',
    'AnnotationType_InsertionChange', 'UIA_TextEditPatternId',
    'UIA_IndentationLeadingAttributeId', 'ToggleState_Off',
    'TreeScope_Element', 'AnnotationType_UnsyncedChange',
    'NotificationProcessing_CurrentThenMostRecent',
    'IUIAutomationElement5', 'StyleId_Subtitle', 'IUIAutomation4',
    'UIA_DropTarget_DragEnterEventId',
    'AnnotationType_AdvancedProofingIssue',
    'UIA_LiveRegionChangedEventId', 'TextUnit_Word',
    'NotificationProcessing_ImportantMostRecent',
    'UIA_MarginLeadingAttributeId', 'TextEditChangeType',
    'StyleId_BulletedList', 'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_ControllerForPropertyId',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'IUIAutomation3', 'UIA_ProcessIdPropertyId',
    'UIA_UnderlineStyleAttributeId',
    'UIA_Selection_InvalidatedEventId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_CultureAttributeId', 'UIA_Transform2ZoomMinimumPropertyId',
    'UIA_VirtualizedItemPatternId',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_FlowsToPropertyId', 'UIA_AutomationPropertyChangedEventId',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_SpreadsheetItemPatternId', 'UIA_FillTypePropertyId',
    'UIA_ValueValuePropertyId',
    'UIA_IsTablePatternAvailablePropertyId',
    'IUIAutomationRangeValuePattern', 'IUIAutomationElement6',
    'UIA_ListItemControlTypeId', 'UIA_ToolTipControlTypeId',
    'SynchronizedInputType_KeyDown',
    'UIA_IsTextPatternAvailablePropertyId', 'UIA_SizePropertyId',
    'NotificationKind_Other', 'UIA_OutlineColorPropertyId',
    'UIA_ToolTipClosedEventId', 'UIA_ChangesEventId',
    'UIA_ImageControlTypeId', 'UIA_RangeValuePatternId',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_SliderControlTypeId', 'UIA_CaretPositionAttributeId',
    'UIA_MainLandmarkTypeId', 'UIA_IsHiddenAttributeId',
    'UIA_LineSpacingAttributeId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_ProviderDescriptionPropertyId', 'UIA_LandmarkTypePropertyId',
    'UIA_TextChildPatternId', 'IUIAutomationScrollItemPattern',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_AnnotationTargetPropertyId', 'UIA_GridItemRowSpanPropertyId',
    'UIA_SpreadsheetPatternId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'IUIAutomationTablePattern', 'CoalesceEventsOptions_Enabled',
    'UIA_GroupControlTypeId',
    'UIA_MultipleViewSupportedViewsPropertyId', 'TextUnit_Document',
    'UIA_StylesFillPatternStylePropertyId', 'HeadingLevel2',
    ...
    'UIA_IsReadOnlyAttributeId', 'CUIAutomation',
    'UIA_AutomationIdPropertyId', 'UIA_HasKeyboardFocusPropertyId',
    'UIA_Window_WindowClosedEventId', 'IUIAutomationTextRange',
    'ProviderOptions_HasNativeIAccessible',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'IUIAutomationGridItemPattern', 'StyleId_Heading8',
    'UIA_IndentationFirstLineAttributeId',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_ThumbControlTypeId', 'NavigateDirection_PreviousSibling',
    'IUIAutomationCustomNavigationPattern',
    'ScrollAmount_SmallIncrement', 'UIA_DropTargetPatternId',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_CaretBidiModeAttributeId', 'UIA_Text_TextChangedEventId',
    'IUIAutomation', 'RowOrColumnMajor_ColumnMajor',
    'UIA_DockPatternId', 'ExpandCollapseState_PartiallyExpanded',
    'CoalesceEventsOptions', 'UIA_ValuePatternId',
    'UIA_TabControlTypeId', 'UIA_MenuModeEndEventId', 'HeadingLevel4',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_AnnotationPatternId', 'AnnotationType_EditingLockedChange',
    'ExpandCollapseState_Collapsed', 'UIA_GridItemPatternId',
    'UIA_IsDockPatternAvailablePropertyId', 'DockPosition_Fill',
    'UIA_LegacyIAccessibleStatePropertyId', 'TreeTraversalOptions',
    'UIA_LegacyIAccessibleRolePropertyId', 'UIA_IsItalicAttributeId',
    'UIA_MenuItemControlTypeId', 'TreeScope_Subtree',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_ToggleToggleStatePropertyId',
    'UIA_RangeValueSmallChangePropertyId',
    'UIA_ProgressBarControlTypeId',
    'UIA_AnnotationDateTimePropertyId', 'IUIAutomationEventHandler',
    'IUIAutomation2', 'WindowInteractionState_Running',
    'UIA_TableRowOrColumnMajorPropertyId', 'UIA_CustomLandmarkTypeId',
    'StructureChangeType', 'IUIAutomationTextPattern2',
    'UIA_IsOffscreenPropertyId', 'TextPatternRangeEndpoint_Start',
    'UIA_SelectionSelectionPropertyId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_SpinnerControlTypeId', 'UIA_IndentationTrailingAttributeId',
    'UIA_DropTarget_DragLeaveEventId',
    'TreeTraversalOptions_LastToFirstOrder', 'ExtendedProperty',
    'ProviderOptions_NonClientAreaProvider', 'UiaChangeInfo',
    'CUIAutomation8', 'UIA_DropTarget_DroppedEventId',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_StyleIdAttributeId', 'IRawElementProviderSimple',
    'UIA_EditControlTypeId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_Transform2CanZoomPropertyId', 'UIA_TablePatternId',
    'UIA_GridItemRowPropertyId', 'UIA_AnnotationAuthorPropertyId',
    'ScrollAmount_LargeDecrement', 'IUIAutomationDropTargetPattern',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_Window_WindowOpenedEventId', 'UIA_TextPattern2Id',
    'StructureChangeType_ChildRemoved', 'Off',
    'UIA_ControlTypePropertyId', 'UIA_Transform2ZoomLevelPropertyId',
    'NotificationProcessing_All', 'AnnotationType_Unknown',
    ...
    'TreeScope_Children', 'IUIAutomationTextRange3',
    'DockPosition_Right', 'UIA_TextControlTypeId',
    'OrientationType_Horizontal', 'StyleId_Heading4',
    'UIA_TransformCanResizePropertyId',
    'ConnectionRecoveryBehaviorOptions', 'UIA_LiveSettingPropertyId',
    'UIA_ScrollItemPatternId', 'UIA_DragIsGrabbedPropertyId',
    'UIA_PaneControlTypeId', 'IUIAutomationTableItemPattern',
    'UIA_StylesStyleNamePropertyId', 'TreeScope_Descendants',
    'TextEditChangeType_AutoComplete',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'StructureChangeType_ChildAdded', 'StyleId_NumberedList',
    'TreeTraversalOptions_Default', 'SynchronizedInputType',
    'IUIAutomationEventHandlerGroup', 'UIA_TreeControlTypeId',
    'StyleId_Heading7', 'IUIAutomationOrCondition',
    'IUIAutomationSelectionPattern', 'DockPosition_Top',
    'UIA_IsDataValidForFormPropertyId', 'WindowInteractionState',
    'UIA_ForegroundColorAttributeId', 'UIA_LinkAttributeId',
    'UIA_ItemContainerPatternId', 'UIA_CenterPointPropertyId',
    'UIA_RangeValueValuePropertyId', 'StyleId_Custom',
    'AutomationElementMode', 'PropertyConditionFlags',
    'UIA_FormLandmarkTypeId', 'UIA_AcceleratorKeyPropertyId',
    'UIA_RotationPropertyId', 'UIA_GridRowCountPropertyId',
    'IUIAutomationTreeWalker', 'ScrollAmount',
    'IUIAutomationElement7', 'WindowInteractionState_NotResponding',
    'TreeScope_Parent', 'UIA_SystemAlertEventId',
    'IUIAutomationTransformPattern2', 'IUIAutomation6',
    'AnnotationType_Mathematics', 'UIA_SearchLandmarkTypeId',
    'UIA_FontSizeAttributeId', 'UIA_AnnotationTypesPropertyId',
    'UIA_StyleNameAttributeId', 'UIA_DockDockPositionPropertyId',
    'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_WindowCanMaximizePropertyId', 'TextUnit_Page',
    'UIA_GridPatternId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_AnnotationObjectsPropertyId', 'StyleId_Normal',
    'IUIAutomationSpreadsheetPattern', 'UIA_InvokePatternId',
    'StyleId_Heading3', 'UIA_ScrollVerticallyScrollablePropertyId',
    'UIA_NamePropertyId', 'UIA_StrikethroughStyleAttributeId',
    'UIA_FrameworkIdPropertyId', 'StyleId_Heading5',
    'UIA_IsPeripheralPropertyId', 'UIA_DescribedByPropertyId',
    'IAccessible', 'TreeTraversalOptions_PostOrder',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_SelectionItemPatternId', 'UIA_OverlineStyleAttributeId',
    'TreeScope_Ancestors', 'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_Drag_DragStartEventId', 'HeadingLevel8',
    'UIA_TransformPatternId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'IUIAutomationElement4', 'ZoomUnit_SmallDecrement',
    'UIA_ClassNamePropertyId', 'ZoomUnit_LargeDecrement',
    'UIA_CulturePropertyId', 'TextEditChangeType_None',
    'UIA_ExpandCollapsePatternId', 'UIA_RangeValueMinimumPropertyId',
    'IUIAutomationNotificationEventHandler',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_DocumentControlTypeId', 'UIA_IsSuperscriptAttributeId',
    'DockPosition_Left', 'TextUnit', 'UIA_TreeItemControlTypeId',
    'ProviderOptions_RefuseNonClientSupport',
    'AnnotationType_FormulaError', 'DockPosition_None',
    'ScrollAmount_LargeIncrement',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'UIA_WindowIsTopmostPropertyId', 'HeadingLevel7',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'AnnotationType_FormatChange', 'UIA_BackgroundColorAttributeId',
    'UIA_AriaPropertiesPropertyId', 'TextPatternRangeEndpoint_End',
    'SynchronizedInputType_LeftMouseDown', 'UIA_TextPatternId',
    'UIA_IsKeyboardFocusablePropertyId', 'Assertive',
    'TextUnit_Character', 'NavigateDirection_LastChild',
    'PropertyConditionFlags_IgnoreCase', 'UIA_CalendarControlTypeId',
    'IUIAutomationMultipleViewPattern', 'StyleId_Quote',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'AnnotationType_Author', 'AnnotationType_Footer',
    'IUIAutomationProxyFactoryMapping',
    'UIA_GridItemColumnPropertyId',
    'IUIAutomationExpandCollapsePattern',
    'UIA_ValueIsReadOnlyPropertyId', 'IUIAutomationElement',
    'DockPosition_Bottom', 'UIA_SummaryChangeId',
    'UIA_NativeWindowHandlePropertyId',
    'NotificationProcessing_MostRecent',
    'UIA_AsyncContentLoadedEventId', 'AnnotationType_Sensitive',
    'TextUnit_Format', 'UIA_Drag_DragCompleteEventId',
    'UIA_NotificationEventId', 'UIA_Invoke_InvokedEventId',
    'UIA_NavigationLandmarkTypeId', 'UIA_TabItemControlTypeId',
    'UIA_ItemStatusPropertyId', 'UIA_ComboBoxControlTypeId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_RadioButtonControlTypeId', 'UIA_HeaderControlTypeId',
    'NotificationKind', 'IUIAutomationItemContainerPattern',
    'IUIAutomationTextRangeArray',
    'UIA_IsTextPattern2AvailablePropertyId',
    'WindowVisualState_Normal', 'StyleId_Heading9',
    'UIA_AriaRolePropertyId', 'LiveSetting', 'IUIAutomationCondition',
    'SupportedTextSelection_Single', 'OrientationType_Vertical',
    'UIA_DataGridControlTypeId', 'NavigateDirection_NextSibling',
    'UIA_AnimationStyleAttributeId', 'UIA_IsEnabledPropertyId',
    'UIA_ClickablePointPropertyId',
    'UIA_IsDragPatternAvailablePropertyId',
    'IUIAutomationSpreadsheetItemPattern',
    'UIA_FullDescriptionPropertyId', 'IUIAutomationDockPattern',
    'SupportedTextSelection_None', 'UIA_StylesStyleIdPropertyId',
    'SynchronizedInputType_RightMouseUp', 'UIA_TogglePatternId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_IsDialogPropertyId', 'UIA_ToolBarControlTypeId',
    'NotificationKind_ActionCompleted',
    'UIA_OutlineThicknessPropertyId', 'UIA_MarginTrailingAttributeId',
    ...
    'UIA_LegacyIAccessibleHelpPropertyId', 'UIA_ButtonControlTypeId',
    'IUIAutomationTextChildPattern',
    'IUIAutomationChangesEventHandler', 'UIA_TitleBarControlTypeId',
    'UIA_SynchronizedInputPatternId', 'UIA_SizeOfSetPropertyId',
    'IUIAutomationElement9', 'UIA_AccessKeyPropertyId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'IUIAutomation5', 'UIA_WindowControlTypeId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_RangeValueLargeChangePropertyId', 'ZoomUnit',
    'UIA_GridItemColumnSpanPropertyId',
    'UIA_LayoutInvalidatedEventId', 'UIA_MenuClosedEventId',
    'UIA_ItemTypePropertyId',
    'UIA_IsWindowPatternAvailablePropertyId', 'ToggleState',
    'IUIAutomationScrollPattern',
    'UIA_Transform2ZoomMaximumPropertyId',
    'IUIAutomationTextEditTextChangedEventHandler', 'HeadingLevel5',
    'UIA_IsPasswordPropertyId',
    'UIA_LegacyIAccessibleValuePropertyId',
    'WindowInteractionState_ReadyForUserInteraction',
    'NavigateDirection_FirstChild',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_TextFlowDirectionsAttributeId', 'UIA_MenuOpenedEventId',
    'IUIAutomationTransformPattern',
    'SupportedTextSelection_Multiple',
    'IUIAutomationObjectModelPattern', 'UIA_TableItemPatternId',
    'UIA_CapStyleAttributeId'
]

_check_version('1.2.0', 1681260990.233307)
